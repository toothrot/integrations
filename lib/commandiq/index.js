...
CommandIQ.prototype.identify = function (identify, fn) {
  ...
  batch.push(function(done){
    self._track(userId, events, done);
  });
...
CommandIQ.prototype.track = function (track, fn) {
...
CommandIQ.prototype._track = function(userId, events, fn){
  var settings = this.settings;
