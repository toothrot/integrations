...
describe('ChurnBee', function(){
  ...
  describe('.validate()', function(){
    ...
    it('should be valid if event is in .events[] array', function(){
      settings.events = [{ key: 'my-event', value: 'register' }];
      test(churnbee).valid({ event: 'my-event' }, settings);
    });
  });
  ...
  describe('mapper', function(){
    describe('track', function(){
      it('should map basic track', function(){
        ...
        test(churnbee, __dirname).fixture('track-basic');
      });
    });
  });
