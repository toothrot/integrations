...
GoogleAnalytics.prototype._pageview = function (track, settings, callback) {
  if (settings.universal) return process.nextTick(callback);
  this.classic._pageview(track, settings, callback);
};
