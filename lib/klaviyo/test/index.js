  ...
  describe('mapper', function(){
    describe('identify', function(){
      it('should map basic identify', function(){
        test(klaviyo, __dirname).fixture('identify-basic', settings);
      });

      it('should fallback to anonymousId', function(){
        test(klaviyo, __dirname).fixture('identify-anonymous-id', settings);
      });
    });

    describe('track', function(){
      it('should map basic track', function(){
        test(klaviyo, __dirname).fixture('track-basic', settings);
      });
    });
  });
